...
export default function Hero() {
    return (
        ...
        >
            {/* لایه تیره */}
            <div className="absolute inset-0 bg-emerald-dark/65 z-10" />
            ...
            <div className="relative z-20 text-center max-w-4xl px-4 pt-28 pb-12 md:pt-36 md:pb-20">
                <span className="inline-block bg-white/5 backdrop-blur-sm border border-white/10 text-gold-light px-4 py-1.5 rounded-full text-xs md:text-sm tracking-wide mb-4 md:mb-6">
                    ✦ تولیدی مبل تک | بیش از یک دهه تجربه در سنندج
                </span>
                ...
                <p className="text-white/80 text-base md:text-xl max-w-2xl mx-auto mb-4 font-light drop-shadow">
                    اصالت سبز زمردی، شکوه طلایی. هر قطعه با عشق و ظرافت در کارگاه تک متولد می‌شود.
                </p>

                <p className="text-white/60 text-sm md:text-base max-w-2xl mx-auto mb-8 font-light">
                    <span className="text-gold-light">تولیدی مبل تک</span>، تولید کننده مبلمان کلاسیک و مدرن در سنندج و ارسال به سراسر کشور.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <Link href="/products" className="bg-gold text-emerald-dark font-bold px-8 py-3.5 md:px-10 md:py-4 rounded-full shadow-xl shadow-gold/30 hover:shadow-gold/50 hover:-translate-y-1 transition-all text-sm md:text-base">
                        مشاهده محصولات مبل تک
                    </Link>
                    <Link href="/about-us" className="border border-white/20 text-white font-semibold px-8 py-3.5 md:px-10 md:py-4 rounded-full hover:border-gold hover:bg-gold/10 backdrop-blur-sm hover:-translate-y-1 transition-all text-sm md:text-base">
                        داستان ما
                    </Link>
                </div>
            </div>
